const translations = {
  en: {
    ...
    questionsMicroCta: "Start asking",
    featureBeaches: "Beach Mood",
    featureSunsets: "Sunset Plans",
    featureTours: "Windy Day Backup",
    featureFood: "Food & Drinks",
    featureTransport: "Getting Around",
    featureLine: "The island shortcut with taste.",
    featureMicroCta: "Ask the island",
    ...
    conciergeBeautyText: "Hair and makeup context for photos, weddings, proposals and special evenings.",
    ...
    conciergeMicroCta: "Ask the island",
    ...
    networkMicroCta: "Ask the island",
  ...
  el: {
    ...
    questionsMicroCta: "Ξεκίνα την ερώτηση",
    featureBeaches: "Παραλίες",
    featureSunsets: "Ηλιοβασίλεμα",
    featureTours: "Ιδέες για αέρα",
    featureFood: "Φαγητό & Ποτό",
    featureTransport: "Μετακινήσεις",
    featureLine: "Πρακτική απάντηση για τη Μύκονο.",
    featureMicroCta: "Ρώτησε το νησί",
    ...
    conciergeMicroCta: "Ρώτησε το νησί",
    ...
    networkEyebrow: "Network",
    partnersMicroCta: "Ξεκίνα την ερώτηση",
    ...
    networkMicroCta: "Ρώτησε το νησί",
    ...
    chatbotMicroCta: "Ξεκίνα την ερώτηση",
