const translations = {
  en: {
    ...
    heroSubtitle: "Ask about beaches, sunsets, tours, food, transport, and what to do today.",
    noAppPart: "Free.",
    noSignupPart: "No app.",
    justAskPart: "No sign-up.",
    valueStrip: "Free. No app. No sign-up. Just ask.",
    heroValueStrip: "Free. No app. No sign-up. Just ask.",
    ...
    featureLine: "Instant answers for Santorini visitors",
    howEyebrow: "How it works",
    howTitle: "Simple, practical guidance in three steps.",
    howLanguageTitle: "Ask in your language",
    howLanguageText: "Type or speak naturally. The AI replies in the language you use.",
    step1Title: "Ask any question about Santorini",
    step1Text: "Get instant, practical answers",
    step2Title: "See local tips and suggestions",
    step2Text: "Book tours or explore more if you wish",
    step3Title: "Always independent, always helpful",
    step3Text: "Some links may be partner recommendations.",
    toursEyebrow: "Tours",
    toursTitle: "Handpicked tours and local experiences",
    toursIntro: "Some links may be partner recommendations. Always independent, always helpful.",
    tourLabelPopular: "Popular",
    tourLabelClassic: "Relaxed",
    tourLabelRomantic: "Romantic",
    tourLabelPractical: "Practical",
    tourCatamaranTitle: "Sunset Catamaran Cruises",
    tourCatamaranText: "Caldera views, swimming stops and sunset from the water.",
    tourVolcanoTitle: "Volcano & Hot Springs Tours",
    tourVolcanoText: "Classic island excursions with practical visitor context.",
    tourWineTitle: "Wine Tasting",
    ...
    conciergeIntro: "For photoshoots, weddings, proposals, beauty services, private transfers and special moments in Santorini.",
    conciergeSeoLine: "Find curated Santorini concierge services for visitors, couples, families and special occasions.",
    conciergePhotographersTitle: "Photographers",
    conciergePhotographersText: "Santorini photographers for couple shoots, honeymoon sessions, family photos, proposal moments and sunset photography.",
    conciergeWeddingTitle: "Wedding Planners",
    conciergeWeddingText: "Local wedding planners for Santorini weddings, elopements, symbolic ceremonies and destination events.",
    conciergeFlowersTitle: "Flowers & Decoration",
    conciergeFlowersText: "Flowers, bouquets, ceremony styling, proposal setups and event decoration for special occasions in Santorini.",
    conciergeTransfersTitle: "Helicopter & Premium Transfers",
    conciergeTransfersText: "Helicopter options, private arrivals and premium transfers through licensed local providers.",
    conciergeBeautyTitle: "Hair & Makeup",
    ...
    networkTitle: "The ASK AI Travel Network",
    networkIntro: "AskSantorini.ai is the first live destination in a growing AI travel guide network.",
    networkSupport: "More destinations are on the way.",
    ...
    termsP2: "AskSantorini.ai is an independent visitor guide and not an official tourism authority.",
    ...
    questions: {
      ...
      beach: "Best beach near me",
      oia: "How to get to Oia",
      oneDay: "Santorini in one day",
      windy: "What to do if it’s windy",
      food: "Best local food",
      family: "Family-friendly ideas"
    },
    answers: {
      sunset: "Oia is iconic but very crowded. Imerovigli and Firostefani are calmer alternatives with beautiful caldera views. For a more relaxed experience, consider a sunset catamaran cruise.",
      catamaran: "A sunset catamaran cruise is one of the strongest Santorini experiences for couples and first-time visitors. It usually combines caldera views, swimming stops and sunset from the water.",
      beach: "Perissa and Perivolos are great for black sand, beach bars and easy access. Kamari is practical and family-friendly. Red Beach is unique but often crowded.",
      oia: "From Fira, you can reach Oia by bus, taxi, private transfer or rental car. Buses are the budget option, but schedules may change in high season.",
      oneDay: "With one day in Santorini, focus on Fira, Oia, one beach and one sunset spot. If you want less stress, choose a caldera walk or a guided tour instead of trying to see everything.",
      windy: "When it’s windy, choose villages, museums, wine tasting, Akrotiri archaeological site, local food or caldera-view cafés. Boat tours may depend on sea conditions.",
      food: "Try fava, tomato fritters, white eggplant, fresh seafood, local wines and simple traditional tavern dishes. Don’t choose only by the view.",
      family: "Kamari beach, Perissa beach, easy boat trips, short village walks, ice cream stops and calm sunset viewpoints usually work well for families."
    }
  },
  el: {
    ...
    heroSubtitle: "Ρώτησε για παραλίες, ηλιοβασιλέματα, εκδρομές, φαγητό, μετακινήσεις και ιδέες για το τι να κάνεις σήμερα.",
    noAppPart: "Δωρεάν.",
    noSignupPart: "Χωρίς εφαρμογή.",
    justAskPart: "Χωρίς εγγραφή.",
    valueStrip: "Δωρεάν. Χωρίς εφαρμογή. Χωρίς εγγραφή. Απλώς ρώτα.",
    heroValueStrip: "Δωρεάν. Χωρίς εφαρμογή. Χωρίς εγγραφή. Απλώς ρώτα.",
    ...
    featureFood: "Φαγητό",
    featureTransport: "Μετακίνηση",
    featureLine: "Άμεσες απαντήσεις για επισκέπτες",
    howEyebrow: "Πώς λειτουργεί",
    howTitle: "Απλή, πρακτική καθοδήγηση σε τρία βήματα.",
    howLanguageTitle: "Ρώτησε στη γλώσσα σου",
    howLanguageText: "Γράψε ή μίλησε φυσικά. Το AI απαντά στη γλώσσα που χρησιμοποιείς.",
    step1Title: "Κάνε οποιαδήποτε ερώτηση για τη Σαντορίνη",
    step1Text: "Πάρε άμεσες, πρακτικές απαντήσεις",
    step2Title: "Δες τοπικές συμβουλές και προτάσεις",
    step2Text: "Κλείσε εκδρομές ή εξερεύνησε περισσότερα αν θέλεις",
    step3Title: "Πάντα ανεξάρτητοι, πάντα χρήσιμοι",
    step3Text: "Ορισμένα links είναι προτάσεις συνεργατών.",
    toursEyebrow: "Εκδρομές",
    toursTitle: "Επιλεγμένες εκδρομές και τοπικές εμπειρίες",
    toursIntro: "Ορισμένα links είναι προτάσεις συνεργατών. Πάντα ανεξάρτητοι, πάντα χρήσιμοι.",
    tourLabelPopular: "Δημοφιλές",
    tourLabelClassic: "Χαλαρό",
    tourLabelRomantic: "Ρομαντικό",
    tourLabelPractical: "Πρακτικό",
    tourCatamaranTitle: "Καταμαράν στο ηλιοβασίλεμα",
    tourCatamaranText: "Θέα στην καλντέρα, στάσεις για μπάνιο και ηλιοβασίλεμα από τη θάλασσα.",
    tourVolcanoTitle: "Εκδρομές στο ηφαίστειο & στα θερμά νερά",
    tourVolcanoText: "Κλασικές εκδρομές στο νησί με πρακτικό πλαίσιο για επισκέπτες.",
    tourWineTitle: "Wine Tasting",
    ...
    conciergeEyebrow: "Concierge",
    conciergeTitle: "Υπηρεσίες Concierge",
    conciergeIntro: "Για φωτογραφίσεις, γάμους, προτάσεις γάμου, υπηρεσίες ομορφιάς, ιδιωτικές μεταφορές και ξεχωριστές στιγμές στη Σαντορίνη.",
    conciergeSeoLine: "Ανακάλυψε επιλεγμένες υπηρεσίες concierge στη Σαντορίνη για επισκέπτες, ζευγάρια, οικογένειες και ειδικές περιστάσεις.",
    conciergePhotographersTitle: "Φωτογράφοι",
    conciergePhotographersText: "Φωτογράφοι στη Σαντορίνη για ζευγάρια, honeymoon, οικογενειακές φωτογραφίσεις, προτάσεις γάμου και ηλιοβασίλεμα.",
    conciergeWeddingTitle: "Wedding Planners",
    conciergeWeddingText: "Τοπικοί wedding planners για γάμους στη Σαντορίνη, elopements, συμβολικές τελετές και destination events.",
    conciergeFlowersTitle: "Άνθη & Διακόσμηση",
    conciergeFlowersText: "Λουλούδια, ανθοδέσμες, στολισμοί τελετών, proposal setups και διακόσμηση εκδηλώσεων στη Σαντορίνη.",
    conciergeTransfersTitle: "Ελικόπτερο & Premium Μεταφορές",
    conciergeTransfersText: "Επιλογές ελικοπτέρου, ιδιωτικές αφίξεις και premium μεταφορές μέσω αδειοδοτημένων τοπικών παρόχων.",
    conciergeBeautyTitle: "Hair & Makeup",
    ...
    networkEyebrow: "Network",
    networkTitle: "Το ASK AI Travel Network",
    networkIntro: "Το AskSantorini.ai είναι ο πρώτος live προορισμός σε ένα αναπτυσσόμενο δίκτυο AI ταξιδιωτικών οδηγών.",
    networkSupport: "Περισσότεροι προορισμοί έρχονται σύντομα.",
    networkLiveBadge: "Live",
    networkSoonBadge: "Coming soon",
    ...
    termsP2: "Το AskSantorini.ai είναι ανεξάρτητος οδηγός επισκεπτών και δεν αποτελεί επίσημο τουριστικό φορέα.",
    ...
    questions: {
      ...
      beach: "Καλύτερη παραλία κοντά μου",
      oia: "Πώς πάω στην Οία",
      oneDay: "Σαντορίνη σε μία μέρα",
      windy: "Τι κάνω αν έχει αέρα",
      food: "Καλύτερο τοπικό φαγητό",
      family: "Ιδέες για οικογένειες"
    },
    answers: {
      sunset: "Η Οία είναι εμβληματική, αλλά έχει πολύ κόσμο. Το Ημεροβίγλι και το Φηροστεφάνι είναι πιο ήρεμες επιλογές με όμορφη θέα στην καλντέρα. Για πιο χαλαρή εμπειρία, αξίζει να δεις και καταμαράν στο ηλιοβασίλεμα.",
      catamaran: "Το καταμαράν στο ηλιοβασίλεμα είναι από τις πιο δυνατές εμπειρίες στη Σαντορίνη, ειδικά για ζευγάρια και επισκέπτες που έρχονται πρώτη φορά. Συνήθως συνδυάζει θέα στην καλντέρα, στάσεις για μπάνιο και ηλιοβασίλεμα από τη θάλασσα.",
      beach: "Η Περίσσα και ο Περίβολος είναι ιδανικές επιλογές για μαύρη άμμο, beach bars και εύκολη πρόσβαση. Το Καμάρι είναι πρακτικό και φιλικό για οικογένειες. Η Κόκκινη Παραλία είναι εντυπωσιακή, αλλά συχνά έχει κόσμο.",
      oia: "Από τα Φηρά μπορείς να πας στην Οία με λεωφορείο, ταξί, ιδιωτική μεταφορά ή ενοικιαζόμενο όχημα. Το λεωφορείο είναι η πιο οικονομική επιλογή, αλλά τα δρομολόγια μπορεί να αλλάζουν στην υψηλή σεζόν.",
      oneDay: "Αν έχεις μία μέρα στη Σαντορίνη, κράτα το πλάνο απλό: Φηρά, Οία, μία παραλία και ένα σημείο για ηλιοβασίλεμα. Για λιγότερο άγχος, διάλεξε είτε βόλτα στην καλντέρα είτε οργανωμένη εκδρομή.",
      windy: "Όταν έχει αέρα, προτίμησε χωριά, μουσεία, wine tasting, τον αρχαιολογικό χώρο στο Ακρωτήρι, τοπικό φαγητό ή café με θέα στην καλντέρα. Οι θαλάσσιες εκδρομές εξαρτώνται από τις συνθήκες.",
      food: "Δοκίμασε φάβα, ντοματοκεφτέδες, λευκή μελιτζάνα, φρέσκο ψάρι, τοπικά κρασιά και απλά πιάτα σε παραδοσιακές ταβέρνες. Μη διαλέγεις μόνο με βάση τη θέα.",
      family: "Το Καμάρι, η Περίσσα, εύκολες βόλτες με καραβάκι, σύντομοι περίπατοι σε χωριά, παγωτό και ήρεμα σημεία για ηλιοβασίλεμα συνήθως λειτουργούν καλά για οικογένειες."
    }
  }
};
