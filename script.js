const translations = {
  en: {
    pageTitle: "AskMykonos.ai – Just Ask Your Mykonos AI Guide",
    metaDescription: "Ask Mykonos in real time. Get instant AI answers about beaches, sunsets, tours, food, transport and local experiences in Mykonos. No app. No sign-up. Just ask.",
    ogTitle: "AskMykonos.ai – Just Ask Your Mykonos AI Guide",
    ogDescription: "Ask Mykonos in real time. Get instant AI answers about beaches, sunsets, tours, food, transport and local experiences. No app. No sign-up.",
    twitterDescription: "Ask Mykonos in real time. Get instant AI answers about beaches, sunsets, tours, food, transport and local experiences.",
    navHow: "How it works",
    navTours: "Tours",
    ...
    heroTitle: "JUST ASK",
    heroSubtitle: "Your AI travel concierge for Mykonos.",
    noAppPart: "Free.",
    noSignupPart: "No app.",
    ...
    previewMode: "Live Ask Mykonos AI",
    ...
    chatGreeting: "Hi! I'm your local Mykonos AI. Ask me anything.",
    ...
    chatSampleQuestion1: "What should I do in Mykonos today?",
    ...
    chatSampleAnswer2: "Little Venice and the windmills are famous but busy. Agios Ioannis and Armenistis Lighthouse are calmer, while a sunset boat cruise is a more relaxed premium option.",
    ...
    previewLabel: "Live Ask Mykonos AI",
    ...
    featureLine: "Ask for a direct Mykonos answer",
    ...
    step2Text: "Compare Little Venice or Ano Mera, boat or beach, bus or private transfer.",
    ...
    toursIntro: "Ask about sunset catamarans, Delos swims, wine routes and sea days without overplanning.",
    ...
    tourCatamaranText: "Aegean views, swimming stops and a quieter sunset from the sea.",
    tourVolcanoTitle: "Curious about Delos?",
    tourVolcanoText: "Ask whether Delos, Rhenia and swimming stops fit your day.",
    tourWineTitle: "Want a slow wine route?",
    tourWineText: "Local flavors, island wines and an easy evening rhythm.",
    ...
    networkIntro: "AskMykonos.ai is the first live destination in a growing AI travel guide network.",
    ...
    earlyAccessTitle: "Ready to ask your Mykonos question?",
    ...
    questions: {
      ...
      oia: "How to get to Ano Mera",
      oneDay: "Mykonos in one day",
      windy: "What to do if it’s windy",
      food: "Best local food",
      family: "Family-friendly ideas"
    },
    answers: {
      sunset: "Little Venice and the windmills are iconic but busy. Agios Ioannis and Armenistis Lighthouse are calmer sunset options. For a more relaxed experience, consider a sunset boat cruise.",
      catamaran: "A sunset boat or catamaran cruise is one of the strongest Mykonos experiences for couples and first-time visitors. It can combine Rhenia swimming stops, Delos views and sunset from the water.",
      beach: "Ornos and Platis Gialos are practical and easy. Psarou and Paraga are lively, while Agios Sostis and Fokos feel quieter when conditions are right.",
      oia: "From Mykonos Town, you can reach Ano Mera by bus, taxi, private transfer or rental car. Buses are the budget option, but schedules may change in high season.",
      oneDay: "With one day in Mykonos, focus on Mykonos Town, Little Venice, one beach and one sunset spot. If you want less stress, choose a Delos boat trip or a simple beach-and-town plan instead of trying to see everything.",
      windy: "When it’s windy, choose Mykonos Town lanes, Ano Mera, museums, local food or sheltered cafés. Boat tours and exposed beaches may depend on sea conditions.",
      food: "Try kopanisti, louza, fresh seafood, amygdalota, local cheeses and simple traditional tavern dishes. Don’t choose only by the view.",
      family: "Ornos beach, Platis Gialos, easy boat trips, short town walks, ice cream stops and calm sunset viewpoints usually work well for families."
    }
  },
  el: {
    ...
    chatGreeting: "Γεια! Είμαι ο τοπικός AI οδηγός σου για τη Μύκονο. Ρώτησέ με ό,τι θέλεις.",
    ...
    featureLine: "Ρώτησε για άμεση απάντηση στη Μύκονο",
    ...
    toursIntro: "Ρώτησε για καταμαράν στο ηλιοβασίλεμα, Δήλο, Ρήνεια, wine routes και μέρες στη θάλασσα χωρίς υπερβολικό πρόγραμμα.",
    ...
    networkIntro: "Το AskMykonos.ai είναι ο πρώτος live προορισμός σε ένα αναπτυσσόμενο δίκτυο AI ταξιδιωτικών οδηγών.",
    ...
    questions: {
      ...
      oia: "Πώς πάω στην Άνω Μερά",
      oneDay: "Μύκονο σε μία μέρα",
